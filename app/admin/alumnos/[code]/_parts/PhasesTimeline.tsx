...
export default function TeamPickerModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      />
      <div className="relative z-10 w-full max-w-2xl overflow-hidden rounded-xl border border-border bg-card">
        ...
        <div className="p-4">
          <div className="relative mb-3">
            ...
            <input
              ...
              className="w-full rounded-md border border-input bg-background py-2 pl-9 pr-3 text-sm transition-colors focus:outline-none focus:ring-2 focus:ring-ring"
            />
          </div>
