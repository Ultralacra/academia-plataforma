              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={(v) =>
                      setForm({ ...form, paymentPlatform: v as PaymentPlatform })
                    }
                  >
                    <SelectTrigger className="w-full">
                      <SelectValue />
          ...
          <TabsContent value="contrato" className="m-0">
            <Card className="p-4 space-y-4">
              <div className="flex items-center gap-2">
                ...
                />
                <Label htmlFor="thirdParty">Contrato a nombre de otra persona</Label>
              </div>
                ...
                {(form.contractParties || []).map((party, idx) => (
                  <Card key={idx} className="p-3">
                    <div className="flex items-center justify-between mb-3">
                      <div className="text-sm font-medium">Persona #{idx + 1}</div>
                      <div className="flex items-center gap-2">
                        {idx === 0 ? (
                          <Button
                            type="button"
                            ...
                            onClick={() =>
                              setForm((prev) => ({
                                ...prev,
                                contractParties: [
                                  { name: prev.fullName, email: prev.email, phone: prev.phone },
                                  ...((prev.contractParties || []).slice(1) as any),
                                ],
                              }))
                            }
                          >
                ...
                <div className="flex justify-end">
                  <Button
                    ...
                    onClick={() =>
                      setForm((prev) => ({
                        ...prev,
                        contractParties: [...(prev.contractParties || []), { name: "", email: "", phone: "" }],
                      }))
                    }
                  >
                    Agregar persona
...
export function CloseSaleForm({
  ...
  useEffect(() => {
    setForm((prev) => ({
      ...
      contractThirdParty: initial?.contractThirdParty ?? prev.contractThirdParty,
      contractPartyName: initial?.contractPartyName ?? prev.contractPartyName,
      contractPartyEmail: initial?.contractPartyEmail ?? prev.contractPartyEmail,
      contractPartyPhone: initial?.contractPartyPhone ?? prev.contractPartyPhone,
      contractParties:
        (initial?.contractParties as any) ??
