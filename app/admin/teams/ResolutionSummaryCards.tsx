...
export default function ResolutionSummaryCards({
  avgMinutes,
  avgHms,
  resolved,
  total,
  ...
  return (
    <div className={`grid grid-cols-1 gap-4 md:grid-cols-2 ${className ?? ""}`}>
      ...
      {/* Card: Tasa de resolución + chips */}
      <div className="relative overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm">
        <div className="absolute inset-y-0 left-0 w-1.5 bg-gradient-to-b from-emerald-500 via-green-500 to-lime-500" />
        <div className="p-4">
