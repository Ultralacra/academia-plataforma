...
function Header({ title, subtitle }: any) {
  return (
    <div className="border-b border-gray-200 bg-gradient-to-r from-indigo-50 to-purple-50 px-5 py-4">
...
function TooltipContent({ active, payload, label }: any) {
  ...
  return (
    <motion.div
      ...
      className="rounded-xl border border-gray-200 bg-white/95 px-3 py-2 text-xs shadow-lg backdrop-blur-sm"
    >
