        ...
        <>
          <div className="space-y-3 rounded-lg border border-border bg-card p-4">
            ...
            {rows.length !== dedupedRows.length && (
              <div className="rounded-md border border-amber-300/60 bg-amber-500/10 px-3 py-2 text-xs text-amber-900 dark:text-amber-200">
            ...
            {allPhaseBreakdown.map((item) => (
              <div
                ...
                className={`rounded-md border px-3 py-3 ${
                  includedPhases[item.fase]
                    ? "border-cyan-300/60 bg-cyan-500/10 dark:border-cyan-500/30 dark:bg-cyan-500/15"
              ...
              >
                ...
                <div className="mt-1 flex flex-wrap gap-1.5 text-[11px]">
                  <span className="rounded bg-emerald-100 px-1.5 py-0.5 text-emerald-800 dark:bg-emerald-500/15 dark:text-emerald-200">
                    Activos {item.activos}
                  </span>
                  <span className="rounded bg-rose-100 px-1.5 py-0.5 text-rose-800 dark:bg-rose-500/15 dark:text-rose-200">
                    Inactivos {item.inactivos}
                  </span>
                  {item.otros > 0 && (
                    <span className="rounded bg-slate-100 px-1.5 py-0.5 text-slate-700 dark:bg-slate-500/15 dark:text-slate-200">
                      Otros {item.otros}
                    </span>
                  )}
                </div>
          ...
          <div className="space-y-3 rounded-lg border border-border bg-card p-4">
            ...
            {ticketsLoading ? (
              ...
              <div className="rounded-md border border-rose-300/40 bg-rose-500/10 px-3 py-2 text-sm text-rose-900 dark:text-rose-200">
                {ticketsError}
              </div>
            ) : (
              <>
