 ...
 */
export function getWelcomeEmailSource() {
  const headerImageUrl =
    "https://lh7-rt.googleusercontent.com/formsz/AN7BsVB-Wa3fKYj_AvJ3YeN6LgBoJR_7Z_naS38QtK0tFYWUdxcttbfYAyX9imwGo2SxxvDo_i2YTHf1cNor7YHJ7k-0UybCeFOolee50-XsCtfAcjzdQts9YycLL6BNWAnMeSDEQ9q8ayR2_H8v3Rl1XxvXbYMFs2at8Yn7MQ1ezf5Vl9I4etpXtbPqddQLwzvs_aYae0RHyqTYs8Dg=w1917?key=vtGBMFfrQpztwyEWSjKe0Q";
  const whatsappLink = "https://wa.link/9ojq40";
...
<head>
  <meta charset="utf-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1" />
  <title>Tu nuevo Portal de soporte de Hotselling</title>
</head>
<body style="margin:0;padding:0;background:#f6f7fb;font-family:ui-sans-serif,system-ui,-apple-system,Segoe UI,Roboto,Helvetica,Arial;">
  <div style="max-width:640px;margin:0 auto;padding:24px;">
    <div style="background:#ffffff;border:1px solid #e7e9f0;border-radius:12px;overflow:hidden;">
      ...
      <div style="padding:22px;">
        <div style="background:#f3f4f6;border:1px solid #e5e7eb;border-radius:10px;padding:14px 14px;margin:0 0 16px 0;">
          ...
          <div style="margin:0;color:#374151;font-size:14px;line-height:1.6;">Queremos informarte que ya está activo nuestro nuevo <b>Portal de Atención al Cliente</b>, que desde ahora será el canal principal de acompañamiento y seguimiento de tu proceso dentro de {{appName}}.</div>
        </div>
        <div style="margin:0 0 14px 0;color:#374151;font-size:14px;line-height:1.6;">Desde este portal podrás:
          <ul style="margin:8px 0 0 18px;padding:0;color:#374151;">
            <li style="margin:6px 0;">Ver el estado de tus consultas</li>
            <li style="margin:6px 0;">Ver las respuestas de tu coach apenas sean respondidas</li>
            <li style="margin:6px 0;">Acceder a la información importante de tu proceso</li>
        ...
        <div style="background:#ffffff;border:1px solid #e5e7eb;border-radius:10px;padding:14px 14px;margin:18px 0;">
          ...
          <div style="margin:6px 0;color:#374151;font-size:14px;line-height:1.6;"><b>Contraseña:</b> {{recipientPassword}}</div>
        </div>
        <div style="margin:18px 0;">
        ...
        <div style="color:#6b7280;font-size:12px;line-height:1.5;">Te recomendamos guardar este correo. Si el botón no funciona, abre este enlace: <span style="word-break:break-all;">{{portalLink}}</span></div>
        <div style="margin-top:16px;color:#374151;font-size:14px;line-height:1.6;"><b>PD:</b> WhatsApp quedará disponible únicamente como canal de respaldo, para apoyarte solo en caso de que no recibas este correo o presentes inconvenientes para ingresar al portal.</div>
        ...
        <div style="margin-top:14px;color:#374151;font-size:14px;line-height:1.6;">Este cambio es para darte más claridad y un mejor acompañamiento.</div>
